    ...
    <main className="h-screen border border-black relative">
      ...
      <div className="flex flex-col">
        ...
        {taskForm && (
          <>
            {/* Background blur */}
            <div className="fixed inset-0 bg-black opacity-50 backdrop-blur-sm z-0"></div>
        ...
        <ul className="flex flex-wrap justify-center p-4 w-full">
          {tasks.map((task) => {
            return <li className="m-3" key={task._id}> <TaskCard task={task} onDelete={deleteTask} onUpdate={updateTask} />
            </li>
          })}
        </ul>
      </div>
